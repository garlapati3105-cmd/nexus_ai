...
import { Search, Filter, AlertTriangle, Fingerprint, MapPin, Pill, ArrowUpRight } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex space-x-3 w-full max-w-lg">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search SKUs or generic names..." className="pl-9 bg-background border-border/50 h-9 text-sm rounded-md shadow-sm" />
          </div>
          <div className="relative">
            <Filter className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
            <Input placeholder="Branch Filter" className="pl-9 w-40 bg-background border-border/50 h-9 text-sm rounded-md shadow-sm" />
          </div>
        </div>
      </div>
